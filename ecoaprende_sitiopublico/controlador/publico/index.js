...
const CATEGORIA_API = 'servicios/cliente/categorias.php';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (DATA.status) {
        ...
        DATA.dataset.forEach(row => {
            ...
            let url = `opciones_categoria.html?id=${row.id_categoria}&nombre=${row.nombre_categoria}`;
            // Se crean y concatenan las tarjetas con los datos de cada categoría.
            CATEGORIAS.innerHTML += `
          <div class="col-4">
            <div class="card mt-4">
              <img src="${SERVER_URL}imagenes/categoria/${row.imagen_categoria}" class="card-img-top" alt="${row.imagen_categoria}">
              <div class="card-body">
