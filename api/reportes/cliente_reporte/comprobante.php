...
require_once('../../modelos/data/carrito_data.php');
require_once('../../modelos/handler/detalle_pedido_data.php');
require_once('../../modelos/data/libro_data.php');
require_once('../../models/data/categorialib_data.php');
...
$pedido = new PedidoData('localhost', 'db_ecoaprende', 'root', '');
...
if ($dataPedidos = $pedido->readByClientAndStatus($_SESSION['idCliente'], 'Pendiente')) {
    foreach ($dataPedidos as $rowPedido) {
        ...
        $detallePedido = new DetallesPedidosData('localhost', 'db_ecoaprende', 'root', '');
...
$filePath = '../../reportes/pdfs/Comprobante_' . time() . '.pdf';
